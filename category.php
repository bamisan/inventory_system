...
$(document).ready(function(){
    ...
    $(document).on('click', '.update', function(){
		...
		var btn_action = 'fetch_single'; //using server side
		$.ajax({
			url:"category_action.php",
			method:"POST",
			data:{category_id:category_id, btn_action:btn_action}, //send data to server
			dataType:"json",
			success:function(data) //receive data from server
			{
				$('#categoryModal').modal('show');
				$('#category_name').val(data.category_name); //recieved data from server side
